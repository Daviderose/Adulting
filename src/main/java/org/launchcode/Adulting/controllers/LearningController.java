...
// Controller for "Dunes Of Learning" Page
@Controller
...
public class LearningController {
    ...
    // Learning page filters quests with the category id matching "learning" id 5
    ...
    public String index(Model model, HttpSession session) {
        ...
        model.addAttribute("title", "The Dunes Of Learning");
