...
// Controller for "Mountains Of Money" Page
@Controller
...
public class SchedulingController {
    ...
    // Learning page filters quests with the category id matching "schedule" id 3
    @RequestMapping(value = "", method = RequestMethod.GET)
    public String index(Model model, HttpSession session) {

        Category cat = categoryDao.findById(3).orElse(null);
