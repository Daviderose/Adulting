...
// Controller for "Jungles Of Home and Lawn" Page
@Controller
...
public class HomeAndLawnController {
    ...
    // Homeandlawn page filters quests with the category id matching "homeandlawn" id 6
    @RequestMapping(value = "", method = RequestMethod.GET)
    public String index(Model model, HttpSession session) {

        Category cat = categoryDao.findById(6).orElse(null);
